      ...
      translation: {
        ...
        reviews:
        {
          ...
          stats:
          {
            ...
            reviews:"Կարծիք",
            recommend:"Խորհուրդ են տալիս"
          },
          items:
          {
            susanna:"Գեղեցիկ և հարմարավետ սրահ, պրոֆեսիոնալ և բարեհամբույր վարպետներ։",
            yelena:"Իմ գեղեցկությունը վստահում եմ միայն պրոֆեսիոնալներին։",
            sona:"Շնորհակալություն գերազանց աշխատանքի համար։"
          },
          cta:
          {
            title:"Եղե՞լ եք մեզ մոտ",
            description:"Կիսվեք ձեր փորձառությամբ և օգնեք մյուսներին ընտրություն կատարել։",
            button:"Թողնել կարծիք"
          }
        }
      },
    },
    ru: {
      translation: {
        ...
        reviews:
        {
          ...
          items:
          {
            susanna:"Красивый и уютный салон, профессиональные и приветливые мастера.",
            yelena:"Я доверяю свою красоту только профессионалам.",
            sona:"Спасибо за отличную работу."
          },
          cta:
          {
