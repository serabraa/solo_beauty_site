    ...
    hy: {
      translation: {
        ...
        cardOffer:
        {
          ...
          label:"Հատուկ առաջարկ ձեզ համար",
          off:"զեղչ",
          cardName:"Նվեր քարտ",
          validity:"Ներկայացրեք <hl>ֆիզիկական և վիրտուալ քարտերը</hl> մեր գեղեցկության սրահում և ստացեք ձեր զեղչը։",
          howTo:"Զեղչը գործում է միայն QR կոդով ֆիզիկական քարտը և այս վիրտուալ քարտը միասին ներկայացնելիս՝ վճարումից առաջ։",
          termsTitle:"Պայմաններ",
          terms:
          [
            "Զեղչը տրամադրվում է միայն բնօրինակ ֆիզիկական քարտը ներկայացնելու դեպքում։ Լուսանկարներն ու պատճենները չեն ընդունվում։",
            "Զեղչը չի համակցվում այլ ակցիաների և առաջարկների հետ։",
            "Մեկ այցի ընթացքում կիրառվում է մեկ զեղչ։"
          ]
        }
      },
    },
    ru: {
      translation: {
        ...
        cardOffer:
        {
          ...
          label:"Специальное предложение для вас",
          off:"скидка",
          cardName:"Подарочная карта",
          validity:"Покажите <hl>физическую и виртуальную карту</hl> в нашем салоне красоты, чтобы получить свой бонус.",
          howTo:"Скидка действует только при предъявлении физической карты с QR-кодом вместе с этой виртуальной картой, до оплаты.",
          termsTitle:"Условия",
          terms:
          [
            "Скидка предоставляется только при предъявлении оригинальной физической карты. Фото и копии не принимаются.",
            "Скидка не суммируется с другими акциями и предложениями.",
            "Одна скидка на одно посещение."
          ]
        }
      },
    },
